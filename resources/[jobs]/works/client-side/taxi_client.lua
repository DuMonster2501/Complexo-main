		...
		if not IsPedInAnyVehicle(ped) then
			...
			if serviceStatus then
				...
				if distance <= 100 then
					...
					DrawMarker(21,stopVehicle[locateSelect][selectPosition][1],stopVehicle[locateSelect][selectPosition][2],stopVehicle[locateSelect][selectPosition][3],0,0,0,0,180.0,130.0,1.5,1.5,1.0,42,137,255,100,0,0,0,1)
...
function generatePassenger(vehicle)
	...
	if HasModelLoaded(mHash) then
		currentPassenger = CreatePed(4,spawnModels[randModels][2],spawnPeds[locateSelect][selectPosition][1],spawnPeds[locateSelect][selectPosition][2],spawnPeds[locateSelect][selectPosition][3],3374176,true,false)
