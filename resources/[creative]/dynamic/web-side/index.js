$(document).ready(function (){
	...
	function goback(){
		var gobackbutton = (`<button style="height:10px; background: #251c31;" id="goback"class ="btn"><div class="title" style="margin-top:-3.8%">Voltar</div><i class="fas fa-chevron-left" style="float: right; margin-top:-3.5%"></i></button>`);
