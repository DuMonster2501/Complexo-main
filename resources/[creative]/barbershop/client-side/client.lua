...
-- DISPLAY OPEN
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("setupChar")
AddEventHandler("setupChar",function(enable)
	displayChar(enable)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- DISPLAY CHAR
-----------------------------------------------------------------------------------------------------------------------------------------
function displayChar(enable)
	local ped = PlayerPedId()
...
local locations = {
	...
	{ 2082.1,-103.21,252.22 },	--- FAVELA VERMELHO
	{ 1414.25,-271.55,178.11 }	--- FAVELA VERDES
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADHOVERFY
-----------------------------------------------------------------------------------------------------------------------------------------
